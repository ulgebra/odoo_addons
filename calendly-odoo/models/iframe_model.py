...
import json
import urllib
class CalendlyIframeModel(models.Model):
    _name = 'calendly.iframe.model'
    _description = 'Calendly Iframe Model'
    ...
    def _compute_dynamic_fields(self):
        ...
        <div class="app-holder">
            <iframe src='/ulgebra-odoo/home?ids={(ids)}&model={model_name}&appCode=calendlyforodoocrm' style='border:0px;'></iframe>
        </div>
        """
        for record in self:
